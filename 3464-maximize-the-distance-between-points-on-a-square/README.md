<h2><a href="https://leetcode.com/problems/maximize-the-distance-between-points-on-a-square/?slug=check-if-digits-are-equal-in-string-after-operations-ii&region=global_v2">3464. Maximize the Distance Between Points on a Square</a></h2><h3>Hard</h3><hr><p>You are given an integer <code><font face="monospace">side</font></code>, representing the edge length of a square with corners at <code>(0, 0)</code>, <code>(0, side)</code>, <code>(side, 0)</code>, and <code>(side, side)</code> on a Cartesian plane.</p>
